...
const coverageBalancedNewsItems = (items, limit = 24) => {
  ...
  for (const topic of newsTopics) {
    ...
    add(items.find((item) => itemCoversTopic(item, topic) && !selectedIds.has(item.id)))
  }
...
export const normalizeNewsItems = (items, limit = 24) =>
