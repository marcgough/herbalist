...
const projectDryRunDirectory = `.tmp/verify-production-deploy-dry-run-${process.pid}-${Date.now()}`
...
try {
  rmSync(resolve(root, projectDryRunDirectory), { recursive: true, force: true })
