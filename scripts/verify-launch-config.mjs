...
const requiredFiles = [
  ...
  'docs/production-operator-brief.json',
  ...
  'scripts/prepare-release-evidence-artifact.mjs',
...
for (const script of [
  ...
  'prepare:production-operator-brief',
  'prepare:production-secrets',
  'prepare:production-state',
  'prepare:release-evidence',
  'prepare:cloudflare-token-requirements',
  ...
  'verify:cloudflare-production-state',
  'verify:cloudflare-token-requirements',
  'verify:completion-audit',
  'verify:corpus-rights',
  'verify:corpus-memory',
  'verify:d1',
  'verify:d1-manifest',
  'verify:dns-cutover',
  'verify:data-exports',
  ...
  'verify:github-production-dispatch-content',
  'verify:github-production-readiness',
  'verify:github-release-evidence-content',
  ...
  'verify:production-deploy-dry-run',
  'verify:production-d1-resolver',
  'verify:production-deploy-workflow',
  'verify:production-feed-seed',
  'verify:production-provisioning',
  'verify:production-operator-brief',
